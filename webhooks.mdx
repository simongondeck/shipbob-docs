...
\| **Topic name** | **Scopes Required**                                       |

\| -------- | ----------------------------------------------- |

\| order\_shipped               | orders\_read                                     |

\| shipment\_delivered      | orders\_read or fulfillments\_read   |

\| shipment\_exception     | orders\_read or fulfillments\_read  |
